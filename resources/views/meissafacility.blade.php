                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 md-mb-50">
                            ...
                            <h2 class="mt-34">Animal Facility Management</h2>
                            ...
                            <p>Its location, assigned project, corresponding costs for which project or experimentation it is being used, type of strain. The facility manager can also update the comments for the cage on a daily basis which notifies the experimenter.</p>
                            <div class="services-img">
